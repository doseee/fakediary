    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: SingleChildScrollView(child: Column(
            children: [
              Text('[제1장 총칙]',
                  style: TextStyle(fontSize: 11, color: Colors.white70, letterSpacing:5)),
              SizedBox(
                height: 10,
              ),
              Text(
